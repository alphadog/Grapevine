...
public class NewReviewActivity extends Activity {
            ...
            public void executeWithUpdatedLocation(Location location) {
                try {
                    if (location != null) {
                        ...
                        valuesMap.put(PendingReviewsTable.PendingReviewCursor.getLatitudeFieldName(),
                                Double.toString(location.getLatitude()));
                        valuesMap.put(PendingReviewsTable.PendingReviewCursor.getLongitudeFieldName(),
                        ...
                        Log.i("NewReviewActivity",
                                "Updating location as new review activity was initiated. New Location is " + location);
    ...
    private void createBlankPendingReview() {
        ...
        synchronized (pendingReviewTable) {
            pendingReviewTable.create(new PendingReview(reviewId, "", "", "", imagePath, "", "", 1, currentTime
                    .format3339(false), null, null, "", PendingReviewsTable.INITIAL_STATUS, 0));
        }
    }
    ...
    public static long getCurrentTime() {
        ...
        reviewTime.setToNow();
        // This is the id name the image and is passed across to the new review activity so that
        // it can be used across all places to refer the same review
